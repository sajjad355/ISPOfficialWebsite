...
<body>
    <div class="header" id="topheader">
        ...
        <section class="header-section">
              <div class="center-div">
                  <h1 class="font-weight-bold">We are The ISP Provider</h1>
    ...
    <section class="project-work">
      ...
      <div class="container d-flex justify-content-around align-items-center text-center">
        ...
        <div>
          ...
          <p>New Wifi Connection(This Month)</p>
        </div>

        <div>
          <h1 class="count">7</h1>
          <p>New Disline Connection(This Month)</p>
        </div>
      </div> 
    </section>     
    <!-- Happy clients end       -->
    ...
    <section class="pricing" id="pricingdiv">
      <div class="container headings text-center">
        <h1 class="text-center font-weight-bold text-white">OUR BEST PRICING</h1><br>
      </div>
      <div class="container">
        <div class="row">
    ...
    <section class="header-extra-div">
      <div class="container">
          <div class="row">
              <div class="extra-div col-lg-4 col-md-4 col-12">
                  <a href="#"><i class="fa-3x fa fa-home" aria-hidden="true"></i></i></a>
                  <h2>SHIFTING NEW PLACE</h2>
                  <p style="  text-align: justify; text-justify: inter-word;">I am sajjadur rahman. I am from dinajpur. I am from Dinajpur.I am from Dinajpur.</p>
              </div>
              <div class=" extra-div col-lg-4 col-md-4 col-12">
                  <a href="#"><i class="fa-3x fa fa-pencil-square-o" aria-hidden="true"></i></i></i></a>
                  <h2>CHANGING PACKAGE</h2>
                  <p style="  text-align: justify; text-justify: inter-word;">I am sajjadur rahman. I am from dinajpur. I am from Dinajpur.I am from Dinajpur.</p>
              </div>
              <div class=" extra-div col-lg-4 col-md-4 col-12">
                <a href="#"><i class="fa-3x fa fa-list-ul" aria-hidden="true"></i></i></a>
