                ...
                <div class="col-lg-12">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" class="contact_us_form row"  method="POST" >
                        ...
                        <div class="form-group col-lg-6">
                            ...
                            <br/>
                            <br/>
                            <input type="text" class="form-control" id="contactNumber" name="contactNumber" placeholder="মোবাইল নম্বর ">
                            <br/>
                        </div>
                        ...
                        <input type="radio" name="ftp" value="না"/> &nbsp না<br/>
                         ...
                         <div class="form-group col-lg-6">
                            &nbsp ৯।&nbsp;  আমাদের সার্ভিস ব্যবহার করে আপনি কতটুকু সন্তুষ্ট ?<br/>                
                        ...
                        <div class="form-group col-lg-12">
                             &nbsp ১০। &nbsp; আমাদের কোম্পানি সম্পর্কে আপনার মূল্যবান মতামত দিন<br/>    
  ...
  <footer class="footersection" id="footerdiv"> 
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6 col-md-12 col-12 footer-div text-center">
          <div>
            <h3>SOCIAL LINKS</h3>
